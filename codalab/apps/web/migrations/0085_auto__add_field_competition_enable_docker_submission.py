...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Competition.enable_docker_submission'
        db.add_column(u'web_competition', 'enable_docker_submission',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Competition.enable_docker_submission'
        db.delete_column(u'web_competition', 'enable_docker_submission')
    ...
    models = {
        ...
        u'web.competition': {
            ...
            'enable_docker_submission': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
